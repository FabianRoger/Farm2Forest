...
```{r}
Sweden <- st_read("/Volumes/Fabian_Work/Lantmateriet/GSD-Sverigekartor_vektor/1_milj/Sverige/Sweref_99_TM/shape/sve_1milj_Sweref_99_TM_shape/svk/riks/ak_riks.shp", stringsAsFactors = FALSE, options = "ENCODING=latin1")
